...
function sqlite_stmt:bind_parameter_count()
   return sqlite3.sqlite3_bind_parameter_count(self.stmt)
end

function sqlite_stmt:bind_parameter_name(n)
   return ffi.string(sqlite3.sqlite3_bind_parameter_name(self.stmt, n))
end

function sqlite_stmt:bind_parameter_index(n)
   return sqlite3.sqlite3_bind_parameter_index(self.stmt, n)
end
...
function sqlite_stmt:get_named_types()
	...
	for i=0,sqlite3.sqlite3_column_count(self.stmt)-1 do
		tbl[ffi.string(sqlite3.sqlite3_column_name(self.stmt, i))] = ffi.string(sqlite3.sqlite3_column_decltype(self.stmt, i))
	end
	return tbl
end
...
function sqlite_stmt:get_named_values()
   local tbl = {}
   for i=0,sqlite3.sqlite3_column_count(self.stmt)-1 do
      tbl[ffi.string(sqlite3.sqlite3_column_name(self.stmt, i))] = self:get_value(i)
   end
   return tbl
end   
